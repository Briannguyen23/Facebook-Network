...
//private DictionaryInterface<T, Vertex<T>> vertices;
    ...
    public QueueInterface<T> getDepthFirstTraversal(T origin)
    {
        ...
        while (!vertexStack.isEmpty())
        {
            ...
            if((topVertex!=null) && topVertex.hasNeighbor()) {
                nextNeighbor = topVertex.getUnvisitedNeighbor();
    ...
    public boolean addVertex(T vertexLabel) {
        ...
        return addOutcome == null; // Was addition to dictionary unsucessful ?
    }
    ...
    public boolean removeVertex(T vertexLabel) {
        // TODO Auto-generated method stub
        //return false;
        VertexInterface<T> addOutcome = vertices.remove(vertexLabel);
        return addOutcome == null; // Was removal to dictionary sucessful ?
    }
    ...
    public boolean removeEdge(T begin, T end, double edgeWeight) {
        ...
        if( (beginVertex != null) && (endVertex != null) )
            result = beginVertex.connectRemove(endVertex, edgeWeight);
