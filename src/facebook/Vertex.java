...
//////////////////////////////////////////////////////////////////////////////////
    ...
    public boolean connectRemove(VertexInterface<T> endVertex, double edgeWeight)
    {
        boolean result = false;
        ...
        {  // Vertices are distinct
            ...
            int edgeCount = 0;
            while (!findEdge && neighbors.hasNext())
            {
                edgeCount++;
                VertexInterface<T> nextNeighbor = neighbors.next();
                if (endVertex.equals(nextNeighbor))
            ...
            if (findEdge)
            {
                edgeList.remove(edgeCount);
                //edgeList.remove(new Edge(endVertex, edgeWeight));
                result = true;
            } // end if
        } // end if
